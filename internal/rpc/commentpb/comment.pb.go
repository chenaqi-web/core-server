...
type CommentInfo struct {
	...
	ReplyToName   string                 `protobuf:"bytes,7,opt,name=replyToName,proto3" json:"replyToName,omitempty"`
...
const file_comment_proto_rawDesc = "" +
	"\n" +
	"\rcomment.proto\x12\acomment\"\xa9\x03\n" +
	...
	"userAvatar\x12.\n" +
	"\areplies\x18\x0e \x03(\v2\x14.comment.CommentInfoR\areplies\"b\n" +
	...
	"\aorderBy\x18\x04 \x01(\tR\aorderBy\"\x88\x01\n" +
