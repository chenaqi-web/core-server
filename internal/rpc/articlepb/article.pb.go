...
const file_article_proto_rawDesc = "" +
	...
	"\rDeleteArticle\x12\x1d.article.DeleteArticleRequest\x1a\x1e.article.DeleteArticleResponse\"\x00B.Z,core-server/internal/rpc/articlepb;articlepbb\x06proto3"
